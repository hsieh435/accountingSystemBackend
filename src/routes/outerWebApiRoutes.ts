...
router.get("/api/outerWebApi/currencyExRateInfo/latest/:currencyCode", authenticateToken, outerWebApiCurrencyExRateControllers.getLatestCurrencyExchangeRate);
